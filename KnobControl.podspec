...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "Ari Prasetyo" => "praszyo@gmail.com" }
  # Or just: spec.author    = "Ari Prasetyo"
  # spec.authors            = { "Ari Prasetyo" => "praszyo@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/Ari Prasetyo"
  ...
  #
   ...
   spec.source       = { :git => "https://github.com/ariprasetyo07/KnobControl.git", :tag => "1.0.0" }
    #spec.source       = { :path => '.' }
